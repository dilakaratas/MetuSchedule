    ...
    <div className="login-wrap">
      <div className="login-card">
        ...
        <div className="login-tabs" role="tablist" aria-label="Giriş türü">
          ...
          >
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
              <path d="M8 2l1.5 3 3.5.5-2.5 2.5.6 3.5L8 10l-3.1 1.5.6-3.5L3 5.5 6.5 5z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
            </svg>
            Yönetici
          </button>
        </div>

        {/* Öğrenci / Personel sekmesi */}
        {!isYnt && (
          <div>
              ...
              {loading ? (
                ...
                <>
                  <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                    <path d="M8 2l1.5 3 3.5.5-2.5 2.5.6 3.5L8 10l-3.1 1.5.6-3.5L3 5.5 6.5 5z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
                  </svg>
